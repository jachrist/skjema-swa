...
function krypterBuffer(klartekst) {
    ...
    // Format: MAGIC(4) | VERSJON(1) | SALT(16) | IV(12) | TAG(16) | ciphertext
    return Buffer.concat([MAGIC, Buffer.from([VERSJON]), salt, iv, tag, ct]);
}

function dekrypterBuffer(container) {
...
module.exports = { krypterBuffer, dekrypterBuffer, MAGIC };
